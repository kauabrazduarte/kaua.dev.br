...
const ICONS: Record<Kind, React.ReactNode> = {
  github: (
    <svg
      ...
      fill="currentColor"
      aria-hidden
      className="h-[18px] w-[18px] transition-transform duration-300 ease-out group-hover:rotate-[10deg] group-hover:scale-110"
    >
  ...
  email: (
    <svg
      ...
      aria-hidden
      className="h-[18px] w-[18px] transition-transform duration-300 ease-out group-hover:-rotate-[8deg] group-hover:scale-110"
    >
